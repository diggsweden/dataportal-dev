import { Containers_devportal_Digg_Containers } from '../graphql/__generated__/Containers';

/**
 * Divides every slug from each container into string parts
 * @param {Array<Containers_devportal_Digg_Containers>} containers
 * @returns {Array<String[]>} An array with stringarrays based on all containerslugs
 */
export const extractSlugs = (containers: (Containers_devportal_Digg_Containers | null)[]) => {
